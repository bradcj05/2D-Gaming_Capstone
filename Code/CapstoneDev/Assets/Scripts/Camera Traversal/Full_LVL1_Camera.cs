...
public class Full_LVL1_Camera : MonoBehaviour
{
     ...
     void Start()
     {
          ...
          if (sceneController.GetPhase() == 1 || sceneController.GetPhase() == 2 || sceneController.GetPhase() == 3)
          {
               vcam_1_2.Priority = 1;
          }
     ...
     void Update()
     {
        ...
        // IF THE GAME WAS PLAYED ALL AT ONCE
        if (vcam_4.Priority == 1 && Phase3_4 && sceneController.GetPhase() == 5) //***
        {
            PhaseNB = !PhaseNB;
            Phase3_4 = !Phase3_4;
            timer = 0;
